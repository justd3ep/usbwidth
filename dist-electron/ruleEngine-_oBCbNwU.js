    ...
    if (device.tier === TIER.MEDIUM) {
      if (isUsb2) {
        ...
        warnings.push({
          id: makeId(),
          severity: "warning",
          code: "MEDIUM_DEV_USB2",
          title: `Medium-bandwidth device on USB 2.0`,
          detail: `"${device.name}" is connected to a USB 2.0 interface. It may be limited to 480 Mbps but is generally sufficient for its tier.`,
